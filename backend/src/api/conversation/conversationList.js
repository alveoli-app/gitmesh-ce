...
exports.default = async (req, res) => {
    ...
    const payload = await new conversationService_1.default(req).findAndCountAll(req.query);
    if (req.query.filter && Object.keys(req.query.filter).length > 0) {
        (0, track_1.default)('Conversations Filtered', { filter: req.query.filter }, Object.assign({}, req));
    }
