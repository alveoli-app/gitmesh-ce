...
exports.default = async (req, res) => {
    ...
    const payload = await new memberService_1.default(req).findAllAutocomplete(req.query.query, req.query.limit);
    await req.responseHandler.success(req, res, payload);
};
//# sourceMappingURL=memberOrganizationAutocomplete.js.map