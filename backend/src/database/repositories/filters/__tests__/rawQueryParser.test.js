...
const rawQueryParser_1 = __importDefault(require("../rawQueryParser"));
describe('RawQueryParser', () => {
    it('Should parse simple filter with an empty second operand', () => {
        ...
        const params = {};
        const result = rawQueryParser_1.default.parseFilters(basicFilter, memberRepository_1.default.MEMBER_QUERY_FILTER_COLUMN_MAP, [], params);
        expect(result).toEqual("((coalesce((m.attributes -> 'isOrganization' -> 'default')::boolean, false) <> :isOrganization_1) and (1=1))");
    ...
    it('Should parse simple default filter', () => {
        ...
        const params = {};
        const result = rawQueryParser_1.default.parseFilters(basicFilter, memberRepository_1.default.MEMBER_QUERY_FILTER_COLUMN_MAP, [], params);
        expect(result).toEqual("((coalesce((m.attributes -> 'isOrganization' -> 'default')::boolean, false) <> :isOrganization_1) and (coalesce((m.attributes -> 'isBot' -> 'default')::boolean, false) = :isBot_1))");
        expect(params.isOrganization_1).toEqual(true);
    ...
    it('Should parse filter with a between condition', () => {
        ...
        const params = {};
        const result = rawQueryParser_1.default.parseFilters(filter, memberRepository_1.default.MEMBER_QUERY_FILTER_COLUMN_MAP, [], params);
        expect(result).toEqual(`((aggs."activityCount" between :activityCount_1 and :activityCount_2) and (1=1))`);
    ...
    it('Should parse filter with attribute column multiselect filter', () => {
        ...
        const params = {};
        const result = rawQueryParser_1.default.parseFilters(filter, memberRepository_1.default.MEMBER_QUERY_FILTER_COLUMN_MAP, [
            {
                property: 'attributes',
                column: 'm.attributes',
                attributeInfos: [
        ...
        expect(result).toEqual(`(((m.attributes -> 'skills' -> 'default') ?& array[:attributes_skills_default_1, :attributes_skills_default_2]) and (1=1))`);
    ...
    it('Should parse filter with attribute column number filter', () => {
        ...
        expect(result).toEqual(`(((m.attributes -> 'age' -> 'default')::integer between :attributes_age_default_1 and :attributes_age_default_2) and (1=1))`);
...
//# sourceMappingURL=rawQueryParser.test.js.map