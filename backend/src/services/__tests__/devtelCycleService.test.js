 ...
 */
const cycleService_1 = __importDefault(require("../../api/devtel/cycles/cycleService"));
...
describe('DevtelCycleService tests', () => {
    ...
    describe('Cycle CRUD operations', () => {
        it('Should create a cycle', async () => {
            ...
            const service = new cycleService_1.default(mockOptions, mockProject.id);
            const cycleData = {
                name: 'Sprint 1',
...
//# sourceMappingURL=devtelCycleService.test.js.map