...
class AuthProfileEditor {
    ...
    async execute(data) {
        ...
        try {
            ...
            await userRepository_1.default.updateProfile(this.options.currentUser.id, this.data, Object.assign(Object.assign({}, this.options), { bypassPermissionValidation: true }));
