...
import SignalsPlatforms from '../SignalsPlatformsDrawers.vue';
import SignalsPublishedDate from '../SignalsPublishedDate.vue';
import SignalsSettingsInclude from '../form/SignalsSettingsInclude.vue';
...
const fillForm = (user) => {
  ...
  const { feed } = signalsSettings.value;
  ...
  form.aiReplies = signalsSettings.value.aiReplies || false;
  formSnapshot();
};
